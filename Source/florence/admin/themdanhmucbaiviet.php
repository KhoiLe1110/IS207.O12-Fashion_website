...
<?php
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST'){
        $blogcatName = $_POST['blogcatName'];

        $insertblogCat = $blog->insert_blogcategory($blogcatName);
    }  
?>
      <nav class="mt-2">
      ...
      <div class="container-fluid">
        <div class="col-md-6">
         <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="themdanhmucbaiviet.php" method="post" class="form-horizontal">
                <div class="card-body">
                  <span>
                    <?php
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="blogcatName" placeholder="Nhập tên danh mục cần thêm...">
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
