        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="themdanhmuc.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Thêm danh mục</p>
                </a>
              </li>
      ...
      <div class="container-fluid">
        <div class="col-md-6">
         <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="themdanhmuc.php" method="post" class="form-horizontal">
                <div class="card-body">
                  <span>
                    <?php
                      if (isset($insertCat)) {
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="catName" placeholder="Nhập tên danh mục cần thêm...">
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
