...
<?php
  ...
  $totalrow = mysqli_num_rows($get_inbox_cart);
        ...
        <div class="card">
          ...
          <div class="card-body">
            <table class="table table-bordered table-hover" style="margin-top: 20px;">
              ...
              <tbody>
                <?php  
                  $get_inbox_cart = $ct->getpage_inbox_cart($start,$limit);
                  if($get_inbox_cart){
                    if($cr_page==1){
                    $i = 0;}else{
                    $i = ($cr_page-1)*10;
                ...
                <tr style="text-align: center;">
                  ...
                  <td>
                    ...
                    if ($result['status'] == 0) {
                    ?>
                        <a href="?shiftid=<?php echo $result['order_code']; ?>"><button class="btn btn-warning">Chờ Xác Nhận</button></a> 
                    <?php 
                    }elseif($result['status'] == 1){
                    ?>                    
                        <a href="?shiftid=<?php echo $result['order_code']; ?>"><button class="btn btn-success">Chờ Vận Chuyển</button></a>
                    <?php  
                    } else { 
                    ?>
            ...
            <div class="row">
              <div class="col-sm-12 col-md-5">
                <div class="dataTables_info" id="example2_info" role="status" aria-live="polite">
                  Hiển thị đơn từ <?php if ($cr_page == 1) { echo 1; } else { echo (($cr_page - 1) * 10) + 1; } ?> tới <?php echo $cr_page*10; ?> trong <?php echo $totalrow; ?> đơn hàng
                </div>
              </div>
              <div class="col-sm-12 col-md-7">
                <div class="dataTables_paginate paging_simple_numbers" id="example2_paginate">
                  <ul class="pagination">
                    <?php if($cr_page-1>0){ ?>
                    <li class="page-item"><a class="page-link" href="quanlydonhang.php?page=<?php echo $cr_page-1; ?>">Prev</a></li>
                    <?php }?>
                    <?php    
                    for ($i=1;$i<=$page;$i++){ 
                    ?>
                    <li class="paginate_button page-item  <?php echo ($cr_page ==$i)? 'active' : '' ?> ">
                      <a href="quanlydonhang.php?page=<?php echo $i; ?>" aria-controls="example2" data-dt-idx="1" tabindex="0" class="page-link"><?php echo $i; ?></a>
                    </li>
                    <?php
                    }
                    ?>
                    ...
                    <li class="paginate_button page-item next" id="example2_next">
                      <a href="quanlydonhang.php?page=<?php echo $cr_page+1; ?>" aria-controls="example2" data-dt-idx="7" tabindex="0" class="page-link">Next</a>
                    </li>
                    <?php }?>
                  </ul>
                </div>
