		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-lg-9 p-b-80">
						...
						$blognews = $blog->get_blog_news_page($start,$limit);
						if($blognews){
							while($result = $blognews->fetch_assoc()){	
						?>
						<div class="p-b-63">
							<a href="blog-detail.php?blogid=<?php echo $result['blogId'] ?>" class="hov-img0 how-pos5-parent">
								<img style="max-height: 550px;" src="admin/uploads/<?php echo $result['image'] ?>" alt="IMG-BLOG">
						...
						for ($i=1;$i<=$page;$i++){ 
						?>
							<a href="blog.php?page=<?php echo $i; ?>" class="flex-c-m how-pagination1 trans-04 m-all-7 <?php echo ($cr_page == $i) ? 'active-pagination1' : ''; ?>">
								<?php echo $i; ?>
							</a>
						<?php  
						}
