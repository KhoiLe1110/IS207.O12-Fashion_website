...
<?php
  ...
  if(!isset($_GET['blogcatid']) || $_GET['blogcatid']==NULL){
    echo "<script>window.location='quanlydanhmucbaiviet.php'</script>";
  }else{
    $id = $_GET['blogcatid'];
    }
    if($_SERVER['REQUEST_METHOD'] === 'POST'){
        $blogcatName = $_POST['blogcatName'];
        $updateblogCat = $blog->update_category($blogcatName, $id);
    }  
?>
      <nav class="mt-2">
      ...
      <div class="container-fluid">
        <div class="col-md-6">
         <div class="card card-info">
              ...
              <!-- form start -->
              <?php
                $get_cate_name = $blog->getcatbyId($id);
                if($get_cate_name){
              ...
              <form action="" method="post" class="form-horizontal">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="blogcatName" value="<?php echo $result['blogcatName'] ?>">
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
