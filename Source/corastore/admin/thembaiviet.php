    ...
    <section class="content">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" name="blogName" id="inputName" class="form-control" required>
                </div>
                <div class="form-group">
                  <label>Danh mục bài viết</label>
                  <select id="select" name="category" class="form-control custom-select" required>
                    <?php 
                    $catlist = $blog->show_blogcategory();
                    if($catlist){
                      while($result = $catlist->fetch_assoc()){ 
                    ?>
                    <option value="<?php echo $result['blogcatId'] ?>"><?php echo $result['blogcatName']?></option>
                   <?php }} ?>
                  </select>
                </div>
                <div class="form-group">
                  <label for="inputDescription">Tóm tắt</label>
                  <textarea id="inputDescription" name="blog_desc" class="form-control" rows="4"></textarea>
                </div>
                <div class="form-group">
                  <label for="pwd">Nội Dung:</label>
                  <textarea class="form-control" rows="5" name="blog_content" id="description"></textarea>
                </div>
                <div class="form-group">
        ...
        <div class="row">
          <div class="col-12">
            ...
            <input type="submit" name="submit" value="Tạo bài viết" class="btn btn-success float-right">
          </div>
        </div></form>
    </section>
  </div>
