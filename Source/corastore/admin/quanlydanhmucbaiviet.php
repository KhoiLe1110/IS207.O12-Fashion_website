...
<?php
    ...
    if(isset($_GET['delId'])){
    $id = $_GET['delId'];
    $delblogCat = $blog->del_category($id);
    }
?>
<!-- Phân Trang -->
<?php
  $show_blogcate = $blog->show_blogcategory();  
  $totalrow = mysqli_num_rows($show_blogcate);
...
?>
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="quanlydanhmucbaiviet.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div><a href="themdanhmucbaiviet.php"><button>Thêm danh mục</button></a></div>
        <br>
        <div class="col-md-6">
              <div class="card">
                ...
                <div class="card-body">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      <?php  
                        $show = $blog->blogcatshow($start,$limit);
                        if($show){
                          $i = 0;
                      ...
                      <tr style="text-align: center;">
                        ...
                        <td style="text-align: center;">
                          <button type="button" class="btn btn-warning" style="width: 50%; margin: 0 auto;"><a style="color: black;" style="text-decoration: none;" href="suadanhmucbaiviet.php?blogcatid=<?php echo $result['blogcatId']?>">Sửa</a></button>
                        </td>
                        <td style="text-align: center;">
                          <button type="button" class="btn btn-danger" style="width: 50%; margin: 0 auto;"><a style="color: white;" onclick="return confirm('Bạn có muốn xóa danh mục này không?')" href="?delId=<?php echo $result['blogcatId']?>">Xóa</a></button>
                        </td>
                      </tr>
                      <?php 
                          } 
                ...
                <div class="card-footer clearfix">
                  <ul class="pagination pagination-sm m-0 float-right">
                    <?php if($cr_page-1>0){ ?>
                    <li class="page-item"><a class="page-link" href="quanlydanhmucbaiviet.php?page=<?php echo $cr_page-1; ?>">«</a></li>
                    <?php }?>
                    <?php    
                    for ($i=1;$i<=$page;$i++){ 
                    ?>
                    <li class="page-item <?php echo ($cr_page ==$i)? 'active' : '' ?> "><a class="page-link" href="quanlydanhmucbaiviet.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                    <?php
                    }
                    ?>
